...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        # Filter DataFrame for all launch sites
        ...
        # Create a pie chart of success/failure counts
        fig = px.pie(
            filtered_df,
            names='class',  # Assuming 'class' column contains success/failure information
